...
<style>
  ...
  .portfolio-frame { display: block; overflow: hidden; aspect-ratio: 9 / 16; border-radius: .75rem; background: #eef1f4; box-shadow: 0 8px 24px rgba(0,0,0,.08); }
...
<div class="portfolio-grid">
  ...
  {% for image in portfolio_images %}
    <article class="portfolio-card">
      <a class="portfolio-frame" href="{{ '/portfolios/work-' | append: forloop.index | append: '/' | relative_url }}" aria-label="Open full portfolio work {{ forloop.index }}">
